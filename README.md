...
Basicamente é um **carrinho de compras** totalmente dinâmico! 🛒

Para isso, vamos consumir dados diretamente de uma **API!** do Mercado Livre para buscar produtos à venda. 🏷

E não para por aí! 🤩

O projeto foi fundamentado com uma mentalidade orientada a testes para a escrita de códigos mais confiáveis e com boa performance.

O Shopping Cart foi desenvolvido como um trabalho para o curso de Desenvolvimento Web da Trybe. A estrutura é similar ao gif: 

![Project Gif](/images/prototipo.gif)

## Ao clonar o projeto:

**Será necessário ter o node versão 16 ou 18 para rodar o npm install**<br>

1- Dê o comando **npm install** <br>
2- Para rodar o projeto, digite: **npm run dev**
